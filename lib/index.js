...
export class OnePageScroller {
  ...
  init(container, options) {
    ...
    this.pages = this.doc.querySelectorAll(this.settings.pageContainer);
  ...
  _transformPage(pos, index, next_el) {
    ...
    const transformCSS = `
            ...
            transition: transform ${this.settings.animationTime}ms ${this.settings.easing};`;
